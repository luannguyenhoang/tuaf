...
const Cnsh = dynamic(() => import('@/features/nganh-cnsh').then((mod) => mod.Cnsh), {
  loading: () => <Loading />,
});
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = ogTitleMatch ? ogTitleMatch[1] : 'Ngành công nghệ sinh học';

...
const Khmt = dynamic(() => import('@/features/nganh-khmt').then((mod) => mod.Khmt), {
  loading: () => <Loading />,
});
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = ogTitleMatch ? ogTitleMatch[1] : 'Ngành khoa học môi trường';
...
export default async function Page() {
  ...
  return (
    <>
      ...
      <Khmt khmt={home_content?.acf?.khmt} />
    </>
  );
}

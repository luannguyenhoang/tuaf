...
const Qltntn = dynamic(() => import('@/features/nganh-qltntn').then((mod) => mod.Qltntn), {
  loading: () => <Loading />,
});
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = ogTitleMatch ? ogTitleMatch[1] : 'Ngành quản lý tài nguyên và môi trường';
...
export default async function Page() {
  ...
  return (
    <>
      ...
      <Qltntn qltntn={home_content?.acf?.qltntn} />
    </>
  );
}

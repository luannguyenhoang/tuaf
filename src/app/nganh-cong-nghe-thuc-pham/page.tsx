...
const Cntp = dynamic(() => import('@/features/nganh-cntp').then((mod) => mod.Cntp), {
  loading: () => <Loading />,
});
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = ogTitleMatch ? ogTitleMatch[1] : 'Ngành công nghệ thực phẩm';
...
export default async function Page() {
  ...
  return (
    <>
      ...
      <Cntp cntp={home_content?.acf?.cntp} />
    </>
  );
}

...
const Qldd = dynamic(() => import('@/features/nganh-qldd').then((mod) => mod.Qldd), {
  loading: () => <Loading />,
});
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = ogTitleMatch ? ogTitleMatch[1] : 'Ngành quản lý đất đai';
...
export default async function Page() {
  ...
  return (
    <>
      ...
      <Qldd qldd={home_content?.acf?.qldd} />
    </>
  );
}

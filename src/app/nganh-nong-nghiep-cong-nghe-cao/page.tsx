...
const Nncnc = dynamic(() => import('@/features/nganh-nncnc').then((mod) => mod.Nncnc), {
  loading: () => <Loading />,
});
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = ogTitleMatch ? ogTitleMatch[1] : 'Ngành nông nghiệp công nghệ cao';
...
export default async function Page() {
  ...
  return (
    <>
      ...
      <Nncnc nncnc={home_content?.acf?.nncnc} />
    </>
  );
}

...
const Xnkns = dynamic(() => import('@/features/nganh-xnkns').then((mod) => mod.Xnkns), {
  loading: () => <Loading />,
});
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = ogTitleMatch ? ogTitleMatch[1] : 'Ngành kinh doanh quốc tế';
...
export default async function Page() {
  ...
  return (
    <>
      ...
      <Xnkns xnkns={home_content?.acf?.xnkns} />
    </>
  );
}

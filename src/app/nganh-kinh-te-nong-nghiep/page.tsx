...
const Ktnn = dynamic(() => import('@/features/nganh-ktnn').then((mod) => mod.Ktnn), {
  loading: () => <Loading />,
});
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = ogTitleMatch ? ogTitleMatch[1] : 'Ngành kinh tế nông nghiệp';
...
export default async function Page() {
  ...
  return (
    <>
      ...
      <Ktnn ktnn={home_content?.acf?.ktnn} />
    </>
  );
}
